-- SEGEMPAT · imutabilidade da evidência de assinatura no preview legado.
-- Depois de formalizada, a assinatura não pode ser sobrescrita nem removida pelo Operador.
