-- Mantém o preview Supabase alinhado às regras corporativas do MySQL/API:
-- 1) avaliações práticas concluídas são evidência imutável;
-- 2) somente avaliações ainda Planejadas podem ser excluídas;
-- 3) toda avaliação precisa de data para permanecer sincronizada com o Cronograma;
-- 4) a data de conclusão do Cronograma vem do encerramento efetivo, não da data planejada.
